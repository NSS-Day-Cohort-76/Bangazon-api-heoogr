...
urlpatterns = [
    ...
    path("reports/inexpensiveproducts", views.inexpensive_products, name="inexpensive_products"),
    path("reports/expensiveproducts", views.expensive_products, name="inexpensive_products"),
